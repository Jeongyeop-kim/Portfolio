...
<div id="wrap">
    ...
    <div id="classify">
    	<div class="classify_box" onclick="location.href='/category/furniture?subc=bed';"><img src="/resources/images_icon/bed.png">침대</div>
    	<div class="classify_box" onclick="location.href='/category/furniture?subc=clo';"><img src="/resources/images_icon/clo.png">옷장</div>
    	<div class="classify_box" onclick="location.href='/category/furniture?subc=tcb';"><img src="/resources/images_icon/tcb.png">책상·의자·책장</div> 
    	<div class="classify_box" onclick="location.href='/category/furniture?subc=kif';"><img src="/resources/images_icon/kif.png">식탁·주방가구</div>
    	<div class="classify_box" onclick="location.href='/category/furniture?subc=lif';"><img src="/resources/images_icon/lif.png">소파·거실가구</div>
    	<div class="classify_box" onclick="location.href='/category/furniture?subc=cut';"><img src="/resources/images_icon/cut.png">침구·커튼</div>
	...
	<form name="frm" method="post" action="/category/interest" >
		<div id="interest_view">
		    ...
		    <button type="button" onclick="location.href='/category/interest';">관심항목 이동</button>
			    <div class="align">
				    <a href="/category/furniture?subc=${subc}&sw=readcount">조회수순</a> 
				    | <a href="/category/furniture?subc=${subc}&sw=lowprice">낮은가격순</a>
				    | <a href="/category/furniture?subc=${subc}&sw=highprice">높은가격순</a> 
				    | <a href="/category/furniture?subc=${subc}&sw=date">신상품순</a>
				</div>
		</div>
		<hr>
	...
	<div id="merchandise_wrap">
		<c:choose>
			<c:when test="${pageInfoMap.count gt 0}">
				<c:forEach var="totalVO" items="${furBoardList}">
					<div id="merchandise">
	...
	<div id="page_control">
		<c:if test="${pageInfoMap.count gt 0}">
			<c:if test="${pageInfoMap.startPage gt pageInfoMap.pageBlock}">
				<a href="/category/furniture?subc=${subc}&sw=${sw}&gPageNum=${pageInfoMap.startPage - pageInfoMap.pageBlock}&gSearch=${gSearch}">[이전]</a>
			</c:if>
			
			<c:forEach var="i" begin="${pageInfoMap.startPage}" end="${pageInfoMap.endPage}" step="1">
				<a href="/category/furniture?subc=${subc}&sw=${sw}&gPageNum=${i}&gSearch=${gSearch}">
				<c:choose>
			...
			<c:if test="${pageInfoMap.endPage lt pageInfoMap.pageCount}">
				<a href="/category/furniture?subc=${subc}&sw=${sw}&gPageNum=${pageInfoMap.startPage + pageInfoMap.pageBlock}&gSearch=${gSearch}">[다음]</a>
			</c:if>
		</c:if>
	<div class="clear"></div>
