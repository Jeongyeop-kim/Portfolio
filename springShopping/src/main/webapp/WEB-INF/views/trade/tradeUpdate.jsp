...
<div id="wrap">
    ...
    <article>
	    <form name="frm" action="/trade/tradeUpdate" method="post" enctype="multipart/form-data">
		<h2>중고매매</h2>
		...
		<div id="write_subject">
			제목<input type="text" name="subject" value="${boardVO.subject}">
		</div>
		...
		<div id="write_content">
			<textarea name="content" rows="15" cols="136">${boardVO.content}</textarea>
		</div>
