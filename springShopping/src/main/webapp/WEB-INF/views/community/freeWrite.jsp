...
<div id="wrap">
    ...
    <article>
	    <form name="frm" action="/community/freeWrite" method="post" enctype="multipart/form-data">
		<h2>자유게시판</h2>
		...
		<div id="write_content">
			<textarea name="content" rows="15" cols="136" class="rememberContent"></textarea>
		</div>
		...
		<div id="write_buttons">
			...
			<input type="button" value="목록보기" class="btn" onclick="location.href='/coummunity/free';">
		</div>
		</form>
    </article>
