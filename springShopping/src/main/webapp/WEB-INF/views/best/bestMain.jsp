...
<div id="wrap">
	...
	<form name="frm" method="post" action="interestProcess.do" >
		<div id="interest_view">
		    <button type="submit">선택상품 관심항목 등록</button>
		    <button type="button" onclick="location.href='interest.do';">관심항목 이동</button>
		</div>
			...
			<c:when test="${pageInfoMap.count gt 0}">
				<c:forEach var="totalVO" items="${bestBoardList}">
				    ...
				    <div class="merchandise_image">
				    	<img src="images_${totalVO.majorc}/${totalVO.path}">
				    </div><br>
						...
						<a href="merchandiseInfo.do?num=${totalVO.num}&gPageNum=${gPageNum}&majorc=${totalVO.majorc}&subc=${totalVO.subc}&name=${totalVO.name}">
